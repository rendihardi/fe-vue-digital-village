...
const headOfFamilyStore = useHeadOfFamilyStore(); // ✅ BUAT DULU

const { deleteHeadOfFamily, getHeadOfFamilyById } = headOfFamilyStore;
...
const fetchData = async () => {
  const response = await getHeadOfFamilyById(route.params.id);
    ...
    <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
      ...
      >
        ...
        <div class="flex items-center w-full gap-3">
          ...
          <div class="flex flex-col gap-1 w-full">
            <p class="font-semibold text-xl leading-[22.5px]">
              {{ getAge(headOfFamily?.date_of_birth) }}
            </p>
            <span class="font-medium text-desa-secondary">
              Umur Kepala Rumah
            </span>
      ...
      <section
        id="Anggota-Keluarga"
        class="flex flex-col rounded-3xl p-6 gap-6 bg-white"
        v-if="headOfFamily?.family_members?.length > 0"
      >
        ...
        <div
          ...
          v-for="(family_member, index) in headOfFamily?.family_members"
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <p class="font-medium leading-5 text-nowrap">
                {{ getAge(family_member?.date_of_birth) }} tahun
              </p>
            </div>
